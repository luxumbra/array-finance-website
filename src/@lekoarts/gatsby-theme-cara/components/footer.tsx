...
const Footer = () => {
  return (
    <>
      <Box as="footer" variant="footer" sx={{ position: `relative`, mb: 0, px: [0, 0, 0], pt: 5, pb: [0, 0, 0], mx: [0, 0, 0], mt: [4, 5, 6], width: `100vw`, minHeight: [`150px`,`150px`,`150px`, `200px`], height: [`150px`,`150px`,`150px`, `200px`], textAlign: `center`, overflow: `hidden`, zIndex: 500 }}>
        <Flex sx={{
          flexFlow: `row nowrap`,
          alignItems: `start`,
          ...
          <Box sx={{
            flex: [`0 1 15%`, `0 1 20%`, `0 1 20%`, `0 1 20%`, `0 1 20%`, `0 1 70%`], width: [`15%`, `20%`, `20%`, `20%`, `20%`, `70%`], textAlign: `left`, zIndex: 200}}>
          <Link href='/'
              sx={{
                display: `block`,
                width: [`35px`,`56px`],
          ...
          <Box sx={{ flex: [`0 1 85%`, `0 0 85%`, `0 0 400px`], width: [`80%`, `80%`, `400px`]}}>
            <ul sx={{
              display: `flex`,
              alignContent: `center`,
              alignItems: `center`,
              ...
              <li>
                <Link href="/" title="Check us out on GitHub">
                    <SVG icon="githubIcon" hiddenMobile color="colors.white" right="0" top="0" width={[`20px`, `32px`]}  preserveAspectRatio="xMidYMid meet" />
                </Link>
              </li>
              <li>
              <Link href="https://twitter.com/arrayfinance" title="Follow us on Twitter">
                    <SVG icon="twitterIcon" hiddenMobile color="colors.white" right="0" top="3px" width={[`20px`, `32px`]} preserveAspectRatio="xMidYMid meet" />
                </Link>
              </li>
              <li>
                <Link href="https://discord.gg/g8CS4252se" title="Join our discord">
                  <SVG icon="discordIcon" hiddenMobile color="colors.white" right="0" top="0" width={[`20px`, `32px`]} preserveAspectRatio="xMidYMid meet" />
                </Link>
              </li>
              <li>
                <Link href="https://medium.com/@arrayfinance" title="Follow us on Medium">
                  <SVG icon="mediumIcon" hiddenMobile color="colors.white" right="0" top="2px" width={[`20px`, `32px`]} preserveAspectRatio="xMidYMid meet" />
                </Link>
              </li>
            </ul>
          </Box>
      ...
      <div sx={{position: `absolute`, bottom: 0, width: [`100vw`], maxWidth: [`100vw`], overflow: `hidden`, height: `700px`, zIndex: 0}}>
        <SVG icon="linesRight2" hiddenMobile width={[100,150,200, 302]} color="icon_darkest" left="0" bottom="100px" opacity={[0.8, 0.5]} transform="scale(-1,-1)" zIndex={0} />
        <SVG icon="roadmapGrid2" hiddenMobile width={[125,155,200, 310]} color="icon_darkest" right={[`-80px`,`-100px`,`-100px`, `-200px`]} bottom={[`100px`,`100px`,`100px`, `150px`]} opacity={1} zIndex={0} />
      </div>
    </>
  )
}
