...
const theme = merge(tailwind, {
  ...
  lineHeights: {
    ...
    body: `1.22`,
    h3: `1.22`,
    heading: [`1.25rem`,             `1.25rem`, `7.8125rem`, `7.8125rem`, `7.8125rem`,             `7.8125rem`],
    subtitle: `41.89px`,
  },
  ...
  styles: {
    ...
    h1: {
      fontSize: [`display.md`, `display.lg`, `display.xl`, `display.xl`, `display.xxl`],
      fontWeight: `heading`,
      mt: 2,
      mb: 3,
    ...
    h2: {
      fontSize: [`display.sm`,             `display.sm`,             `display.sm`,             `display.sm`, `display.xl`, `display.xl`],
      lineHeight: 1.22,
      mt: 2,
      mb: 2,
      color: `heading`,
    ...
    h3: {
      fontSize: [`display.sm`, `display.sm`, `display.sm`, `display.md`, `display.lg`, `display.lg`],
      lineHeight: 1.22,
      mt: [0],
      mb: [2, 3,4],
      color: `heading`,
  ...
  lists: {
    bigList: {
      ...
      li: {
        ...
        backgroundSize: `24px`,
        fontSize: [`display.xs`, `display.xs`, `display.xs`, `display.xl`, `display.md`, `display.md`],
        pr: [0, 6],
        // "::before": {
        //   content: `""`,
        //   display: `block`,
