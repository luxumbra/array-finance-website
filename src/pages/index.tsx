...
const HomePage = () => (
  <Layout>
    ...
    <PageSection styles={{minHeight: [`auto`,`auto`,`auto`,`1205px`, `1205px`, `1005px`], position: 'relative', mt: [200, 0]}}>
      <Flex>
        <Box sx={{
          flex: [`0 0 100%`,`0 0 100%`,`0 0 80%`,`0 0 100%`,`0 1 60%`, `0 1 60%`],
          width: [`100%`, `100%`, `80%`, `60%`, `60%`, `60%`],
          lineHeight: [`sm`, `lg`],
          "p": { fontSize: [`body.xs`,`body.sm`,`body.md`,`display.sm`,`display.md`,`display.md`], lineHeight: `lg`, mt: [3,4,4,5], mb: [3,4,5], width: [`90%`, `90%`,`80%`,`60%`] },
        ...
        <Box sx={{display: [`none`, `block`], position: `relative`, flex: [`0 0 40%`, `0 0 40%`, `0 0 10%`, `0 0 40%`], width: `40%`, overflowX: `visible`, zIndex: 0}}>
          <SVG icon="apyInfoG" color="colors.background" right={[150,150,-90,-20]} top={[0,-50,100, 120]} width={[200,200,250, 426]} preserveAspectRatio="xMidYMid meet" opacity={[0.2, 1]} />
        </Box>
      </Flex>
    </PageSection>
    ...
    <PageSection>
      <Flex sx={{ justifyItems: `space-between`, flexFlow: `row-reverse nowrap`, position: `relative`}}>
        ...
        <Box sx={{position: `relative`, flex: [`0 0 90%`,`0 0 40%`], width: [`90%`, `40%`], overflowX: `visible`, zIndex: 0}}>
          <SVG icon="autoDefi" color="colors.background" left={[`265px`,`265px`,`-50px`, `-150px`]} top={[`-75px`,`-75px`,`-50px`, `-100px`]} width={[`250px`, `200px`,`300px`, `569px`]} preserveAspectRatio="xMidYMid meet" opacity={[0.3, 1]} />
        </Box>
      </Flex>
      {/* <UpDownWide>
    ...
    <PageSection sx={{position: `relative`}}>
      <Flex sx={{ justifyItems: `space-between`, flexFlow: `row wrap`}}>
        <Box sx={{
          ...
          width: [`90%`,`90%`,`71%`, `54%`],
          zIndex: 200,
          "p": { fontSize: [`body.xs`,`body.sm`,`body.md`,`display.sm`,`display.md`,`display.md`], lineHeight: `lg`, mt: [3,4,4], mb: [5,4,5], pr: [0, `50px`] },
          }}>
          <FutureProof />
        </Box>
        ...
        <Box sx={{ position: `relative`, flex: [`0 0 100%`,`0 1 90%`,`0 1 90%`, `0 1 50%`], pt: [3, 5], width: [`90%`,`50%`], justifySelf: `center`, margin: `0 auto` }}>
          <RoadmapPhases phases={roadmapPhases} />
          <CTA text="join our CCO" link="/ccor" type="link" sx={{
            variant: `links.primary`
          }} />
          <SVG icon="roadmapGrid" width={115} color="icon_darkest" left={[0, 0, 50, "-50%"]} top={[-100, -100,-200,"30%"]} opacity={[0.5,0.5,0.5,1]} />
        </Box>
      </Flex>
      {/* <UpDownWide >
